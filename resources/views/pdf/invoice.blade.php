                        ...
                        <tr class="tr">
                            <td class="td">
                                <img style="width: 120px; height: auto;"
                                     src="{{ base_path('public/uploads/product/'.$order->product_photo) }}" alt="...">
                            </td>
    ...
    <div class="">
        <div class="">
            <table>
                <tr>
                    <td>
                        <div style="font-weight: bold; color: #00124E;">Name</div>
                    </td>
                    <td class="px-3">:</td>
                ...
                <tr>
                    <td>
                        <div style="font-weight: bold; color: #00124E;">Email</div>
                    </td>
                    <td class="px-3">:</td>
                ...
                <tr>
                    <td>
                        <div style="font-weight: bold; color: #00124E;">Subtotal</div>
                    </td>
                    <td class="px-3">:</td>
                    <td>${{ $subtotal }}</td>
                </tr>
                <tr>
                    <td>
                        <div style="font-weight: bold; color: #00124E;">Discount</div>
                    </td>
                    <td class="px-3">:</td>
                    <td>-${{ $totalDiscount }}</td>
                </tr>
                <tr>
                    <td>
                        <div style="font-weight: bold; color: #00124E;">Grand total</div>
                    </td>
                    <td class="px-3">:</td>
                    <td>${{ $total }}</td>
                </tr>
