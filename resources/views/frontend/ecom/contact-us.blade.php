        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="contact-address-box mb-4">
                        <div class="contact-address-name">Social Media:</div>
                        <div class="contact-address-icons">
                            <div class="d-flex flex-row">
                                <a href="" class="contact-address-icon">
                    ...
                    <div class="contact-address-box mb-4">
                        <div class="contact-address-name">Head office:</div>
                        <div class="contact-address-info">Rajshahi Sader</div>
                    </div>
