        ...
        <div class="d-flex flex-row justify-content-between header-pdn">
            ...
            <div class="d-flex flex-row ">
                ...
                <div class="top-icon-text-box ms-5">
                    ...
                    <a href="{{route('user.addToCart')}}" class="top-icon-text">Cart (0)</a>
                </div>
            </div>
        </div>
        <hr class="hr-for-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item category-dpd-area dropdown none992">
                        <a class="nav-link dropdown-toggle category-dpd-btn" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
