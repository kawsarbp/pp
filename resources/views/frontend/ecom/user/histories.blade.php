                        ...
                        <div class="purchase-history-area">
                            ...
                            <div class="overflow-x-auto overflow-y-auto purchase-history-table">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="purchase-history-order-number">Order: 76230212094535</div>
                                            <div class="purchase-history-order-date">12th Feb, 2023</div>
                                        </td>
                                        <td><div class="purchase-history-order-amount">$ 1,860.05</div></td>
                                        <td><span class="purchase-history-order-processing-text">Processing</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="purchase-history-order-amount">$ 1,860.05</div></td>
                                        <td><span class="purchase-history-order-cancelled-text">Cancelled</span></td>
                                        <td><span class="purchase-history-order-pending-text"> Pending </span></td>
                                        <td>
                                            <a href="" class="purchase-history-download-btn">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="purchase-history-order-delivered-text">Paid</span></td>
                                        <td>
                                            <a href="" class="purchase-history-download-btn">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
