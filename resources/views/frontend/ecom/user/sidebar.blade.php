<div class="customer-details-area">
    <div class="customer-details-box">
        ...
        <div class="order-details-edit-btn">
            <a href="{{ route('userProfile') }}">edit</a>
        </div>
    </div>
       ...
       {{-- @php
        ...
        @foreach($global_transactions as $transaction)
            @php
                ...
                @endphp
        @endforeach--}}
        <div class="total-balance-amount text-center"> @if(auth()->user()->balance)${{ auth()->user()->balance }}@else $ 00.00 @endif</div>
    ...
    <div class="last-transaction-area">
        ...
        <div class="d-flex flex-row py-2 justify-content-between">
            <div class="transaction-date">{{ date('d-M-Y',strtotime($transaction->created_at)) }}</div>
            <div class="transaction-recharge-text">{{ $transaction->gateway }}</div>
            <div class="transaction-recharge-amount">-$ {{ $transaction->amount }}</div>
        </div>
        @endforeach
...
<div class="dashboard-history-area my-4 ">
    <a href="{{ route('dashboard') }}" class=" {{ request()->routeIs('dashboard') ?'active-dashboard-menu':'dashboard-control-box' }} ">
        <div class="d-flex flex-row align-items-center">
    ...
    <a href="{{ route('userProfile') }}" class=" {{ request()->routeIs('userProfile') ?'active-dashboard-menu':'dashboard-control-box' }}">
        <div class="d-flex flex-row align-items-center">
            <div class="dashboard-control-icon">
