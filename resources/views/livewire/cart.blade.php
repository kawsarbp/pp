                ...
                <div class="row align-items-center">
                        ...
                        <div class="cart-items-qty">
                            <div>
                                ...
                                <div class="d-flex flex-row">
                                    <button wire:click="decQty({{ $cartValue->id }})" type="submit" class="card-items-ind-btn">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-lg" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 2 8Z"/>
                                        </svg>
                                    </button>
                                    <input type="text" class="cart-qty-field" value="{{ $cartValue->product_qty }}" min="1" readonly>
                                    <button wire:click="incQty({{ $cartValue->id }})" type="submit" class="card-items-ind-btn">
                    ...
                    <div class="col-lg-2  col-md-12 ">
                        @if($cartValue->product_discount >0)
                            ...
                            <div class="cart-product-amount-original">$ {{ $discountedPrice * $cartValue->product_qty}}</div>
                        @else
                            <div class="cart-product-amount-original">$ {{ $cartValue->product_price * $cartValue->product_qty}}</div>
                        @endif
